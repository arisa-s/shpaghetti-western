  ...
  return (
    ...
    >
      ...
      <div className="max-w-8xl w-full flex flex-col lg:flex-row gap-8 lg:gap-16 items-center relative z-10 lg:p-16">
        <div className="text-base sm:text-lg max-w-2xl w-full bg-white/60 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg border border-black/5">
          <h2
            id="vision-heading"
          ...
          <p className="text-maroon-dark mb-4 leading-relaxed">
            ...
            <SwHighlightLink onAnimationComplete={handleHighlightComplete}>
              original soundtrack by Grammy award-winning Rhiannon Giddens (ft.
              artist in Beyonce&apos;s Texas Hold &apos;Em).
            </SwHighlightLink>
          </p>
