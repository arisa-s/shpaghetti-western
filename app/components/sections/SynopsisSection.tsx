...
export default function SynopsisSection() {
  return (
    <section id="synopsis" className="relative min-h-screen flex items-center justify-center py-32 px-6 sm:px-8 md:px-16 lg:px-24 overflow-hidden">
      {/* Background Image */}
      <Image
        src="/synopsis.jpg"
        alt="Synopsis"
      ...
      {/* Content */}
      <div className="flex flex-col md:flex-row justify-center relative z-10 gap-12 w-full mt-auto">
        <h2 className="text-4xl md:text-5xl lg:text-9xl font-cowboy text-white mb-8 text-center drop-shadow-2xl">
          Synopsis
        </h2>
        <p className="text-justify text-sm sm:text-base max-w-2xl ml-auto text-white">
